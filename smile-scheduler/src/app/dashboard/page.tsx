            ...
            >
              ...
              <ol className="list-decimal list-inside space-y-5 text-xl">
                <li>
                  ...
                  You can create, edit, or delete any client any time you want!
                </li>
                <li>
                  <strong>Step 2:</strong> Create an appointment date for a
                  client. This will allow you to keep track of upcoming
                  appointments for your busy schedule!
                </li>
                <li>
                  <strong>Step 3:</strong> Enable email notifications so you
